...
public enum AdminAuditAction {
    ...
    SUBJECT_CREATE, SUBJECT_UPDATE, SUBJECT_DELETE, SUBJECT_CLONE, SUBJECT_IMPORT,
    DEPARTMENT_CREATE, DEPARTMENT_UPDATE, DEPARTMENT_DELETE,
    PROCTOR_UNASSIGN,
    // 5. outbound email to students
    REMINDER_CREATE, REMINDER_CANCEL, REMINDER_TEST_SEND
}
